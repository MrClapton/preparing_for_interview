...
import ru.geekbrains.lesson5.services.MarkService;
import ru.geekbrains.lesson5.services.StudentService;
...
public class Lesson5 {
    public static void main(String[] args) {
        ...
        //after persist(student). student: Student{id=9206, firstName='Alex', lastName='Kitaev', mark=Mark{id=1, title='A'}}
        //after persist(student). all students: [Student{id=9206, firstName='Alex', lastName='Kitaev', mark=Mark{id=1, title='A'}}]
        ...
        //after update(student). student: Student{id=9206, firstName='Alex', lastName='Kitaev', mark=Mark{id=3, title='C'}}
        //after update(student). all students: [Student{id=9206, firstName='Alex', lastName='Kitaev', mark=Mark{id=3, title='C'}}]
        ...
        //after persist(student) again. all students: [Student{id=8, firstName='Alex', lastName='Kitaev', mark=Mark{id=3, title='C'}}]
        ...
        //after persist(student1). all students: [Student{id=8, firstName='Alex', lastName='Kitaev', mark=Mark{id=3, title='C'}}, Student{id=9, firstName='Original student first name', lastName='Original student last name', mark=Mark{id=1, title='A'}}]
